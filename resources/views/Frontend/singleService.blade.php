...
@section('pageTitle', isset($pageTitle) ? $pageTitle : $singleService->getTranslatedAttribute("name"))
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="col-md-12">
                    <div class="x_car_detail_main_wrapper">
                        <br/>
                        @if($singleService->photo)
                            <div class="lr_bc_first_box_img_wrapper">
                                <img src="{{url('/')}}/storage/{{ $singleService->photo }}" alt="blog_img">
                            </div>
                        @endif
